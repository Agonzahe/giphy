...
class PublicacionesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publicacione" do
    assert_difference("Publicacione.count") do
      post publicaciones_url, params: { publicacione: { descripcion: @publicacione.descripcion, titulo: @publicacione.titulo, usuario_id: @publicacione.usuario_id } }
    end
  ...
  test "should update publicacione" do
    patch publicacione_url(@publicacione), params: { publicacione: { descripcion: @publicacione.descripcion, titulo: @publicacione.titulo, usuario_id: @publicacione.usuario_id } }
