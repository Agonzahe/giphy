...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference("Label.count") do
      post labels_url, params: { label: { nombre: @label.nombre, publicaciones_id: @label.publicaciones_id } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { nombre: @label.nombre, publicaciones_id: @label.publicaciones_id } }
